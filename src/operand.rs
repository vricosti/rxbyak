...
impl PartialEq for Reg {
    fn eq(&self, other: &Self) -> bool {
        self.idx == other.idx && self.kind as u16 == other.kind as u16 && self.bit == other.bit
    }
}
...
impl Reg {
    ...
    pub const fn gpr8(idx: u8) -> Self {
        Self::new(idx, Kind::Reg, 8)
    }
    pub const fn gpr16(idx: u8) -> Self {
        Self::new(idx, Kind::Reg, 16)
    }
    pub const fn gpr32(idx: u8) -> Self {
        Self::new(idx, Kind::Reg, 32)
    }
    pub const fn gpr64(idx: u8) -> Self {
        Self::new(idx, Kind::Reg, 64)
    }
    pub const fn mmx(idx: u8) -> Self {
        Self::new(idx, Kind::Mmx, 64)
    }
    pub const fn xmm(idx: u8) -> Self {
        Self::new(idx, Kind::Xmm, 128)
    }
    pub const fn ymm(idx: u8) -> Self {
        Self::new(idx, Kind::Ymm, 256)
    }
    pub const fn zmm(idx: u8) -> Self {
        Self::new(idx, Kind::Zmm, 512)
    }
    pub const fn opmask(idx: u8) -> Self {
        Self::new(idx, Kind::Opmask, 64)
    }
    pub const fn fpu(idx: u8) -> Self {
        Self::new(idx, Kind::Fpu, 32)
    }
    pub const fn bndreg(idx: u8) -> Self {
        Self::new(idx, Kind::BndReg, 128)
    }
    ...
    pub fn is_reg(&self) -> bool {
        self.kind as u16 & Kind::Reg as u16 != 0
    }
    pub fn is_reg_bit(&self, bit: u16) -> bool {
        self.is_reg() && (bit == 0 || self.bit == bit)
    }
    pub fn is_mmx(&self) -> bool {
        self.kind as u16 & Kind::Mmx as u16 != 0
    }
    pub fn is_xmm(&self) -> bool {
        self.kind as u16 & Kind::Xmm as u16 != 0
    }
    pub fn is_ymm(&self) -> bool {
        self.kind as u16 & Kind::Ymm as u16 != 0
    }
    pub fn is_zmm(&self) -> bool {
        self.kind as u16 & Kind::Zmm as u16 != 0
    }
    ...
    pub fn is_bndreg(&self) -> bool {
        self.kind as u16 & Kind::BndReg as u16 != 0
    }
    pub fn is_fpu(&self) -> bool {
        self.kind as u16 & Kind::Fpu as u16 != 0
    }
    ...
    pub fn has_evex(&self) -> bool {
        self.is_zmm() || self.is_ext_idx2() || self.mask != 0 || self.rounding as u8 != 0
    }
    ...
    pub fn has_rex2_nf(&self) -> bool {
        self.has_rex2() || self.nf
    }

    /// Does this register require REX2 or NF or ZU?
    pub fn has_rex2_nf_zu(&self) -> bool {
        self.has_rex2() || self.nf || self.zu
    }
    ...
    pub fn cvt8(&self) -> Result<Reg> {
        self.change_bit(8)
    }
    /// Convert to 16-bit register.
    pub fn cvt16(&self) -> Result<Reg> {
        self.change_bit(16)
    }
    /// Convert to 32-bit register.
    pub fn cvt32(&self) -> Result<Reg> {
        self.change_bit(32)
    }
    /// Convert to 64-bit register.
    pub fn cvt64(&self) -> Result<Reg> {
        self.change_bit(64)
    }
    /// Convert to XMM register.
    pub fn cvt128(&self) -> Result<Reg> {
        self.change_bit(128)
    }
    /// Convert to YMM register.
    pub fn cvt256(&self) -> Result<Reg> {
        self.change_bit(256)
    }
    /// Convert to ZMM register.
    pub fn cvt512(&self) -> Result<Reg> {
        self.change_bit(512)
    }
...
impl From<crate::address::Address> for RegMem {
    fn from(m: crate::address::Address) -> Self {
        RegMem::Mem(m)
    }
}
