...
pub static AVX_X_X_XM: &[Insn] = &[
    ...
    Insn::avx(
        "vpermilps",
        T_0F38 | T_66 | T_YMM | T_EVEX | T_W0 | T_B32,
        0x0C,
    ),
    Insn::avx(
        "vpermilpd",
        T_0F38 | T_66 | T_W0 | T_YMM | T_EVEX | T_EW1 | T_B64,
        0x0D,
    ),
    // variable shifts
    Insn::avx(
        "vpsllvd",
        T_0F38 | T_66 | T_W0 | T_YMM | T_EVEX | T_B32,
        0x47,
    ),
    Insn::avx(
        "vpsllvq",
        T_0F38 | T_66 | T_W1 | T_YMM | T_EVEX | T_EW1 | T_B64,
        0x47,
    ),
    Insn::avx(
        "vpsravd",
    ...
    Insn::avx(
        "vcvtsd2ss",
        T_0F | T_F2 | T_EVEX | T_EW1 | T_N8 | T_ER_X,
        0x5A,
    ),
    Insn::avx(
        "vcvtss2sd",
        T_0F | T_F3 | T_EVEX | T_W0 | T_N4 | T_SAE_X,
        0x5A,
    ),
    // insertps
    ...
    Insn::avx(
        "vpackssdw",
        T_0F | T_66 | T_YMM | T_EVEX | T_W0 | T_B32,
        0x6B,
    ),
    ...
    Insn::avx(
        "vpmuludq",
        T_0F | T_66 | T_YMM | T_EVEX | T_EW1 | T_B64,
        0xF4,
    ),
    Insn::avx(
        "vpmuldq",
        T_0F38 | T_66 | T_YMM | T_EVEX | T_EW1 | T_B64,
        0x28,
    ),
    ...
    Insn::avx(
        "vsqrtsd",
        T_0F | T_F2 | T_EVEX | T_EW1 | T_ER_X | T_N8,
        0x51,
    ),
    ...
    Insn::avx_imm(
        "vgf2p8affineinvqb",
        T_66 | T_0F3A | T_W1 | T_EVEX | T_YMM | T_EW1 | T_SAE_Z | T_B64,
        0xCF,
    ),
    Insn::avx_imm(
        "vgf2p8affineqb",
    ...
    Insn::avx(
        "vgf2p8mulb",
        T_66 | T_0F38 | T_W0 | T_EVEX | T_YMM | T_W0 | T_SAE_Z,
        0xCF,
    ),
    // SM3/SM4
    ...
    Insn::avx(
        "vaddph",
        T_MAP5 | T_W0 | T_YMM | T_MUST_EVEX | T_ER_Z | T_B16,
        0x58,
    ),
    Insn::avx(
        "vaddsh",
        T_MAP5 | T_F3 | T_W0 | T_MUST_EVEX | T_ER_X | T_N2,
        0x58,
    ),
    Insn::avx(
        "vsubph",
    ...
    Insn::avx(
        "vmaxph",
        T_MAP5 | T_W0 | T_YMM | T_MUST_EVEX | T_SAE_Z | T_B16,
        0x5F,
    ),
    Insn::avx(
        "vmaxsh",
        T_MAP5 | T_F3 | T_W0 | T_MUST_EVEX | T_SAE_X | T_N2,
        0x5F,
    ),
    Insn::avx(
        "vminph",
    ...
    Insn::avx_imm(
        "vinsertf32x4",
        T_0F3A | T_66 | T_MUST_EVEX | T_W0 | T_YMM | T_N16,
        0x18,
    ),
    Insn::avx_imm(
        "vinsertf64x2",
        T_0F3A | T_66 | T_MUST_EVEX | T_EW1 | T_YMM | T_N16,
        0x18,
    ),
    Insn::avx_imm(
        "vinsertf32x8",
        T_0F3A | T_66 | T_MUST_EVEX | T_W0 | T_YMM | T_N32,
        0x1A,
    ),
    Insn::avx_imm(
        "vinsertf64x4",
        T_0F3A | T_66 | T_MUST_EVEX | T_EW1 | T_YMM | T_N32,
        0x1A,
    ),
    Insn::avx_imm(
        "vinserti32x4",
    ...
    Insn::avx(
        "vpermd",
        T_66 | T_0F38 | T_W0 | T_YMM | T_EVEX | T_B32,
        0x36,
    ),
    Insn::avx(
        "vpermps",
    ...
    Insn::avx(
        "vpdpbssd",
        T_F2 | T_0F38 | T_W0 | T_YMM | T_MUST_EVEX | T_B32,
        0x50,
    ),
    Insn::avx(
        "vpdpbssds",
    ...
    Insn::avx(
        "vpdpbsud",
        T_F3 | T_0F38 | T_W0 | T_YMM | T_MUST_EVEX | T_B32,
        0x50,
    ),
    Insn::avx(
        "vpdpbsuds",
    ...
    Insn::avx(
        "vpdpbuud",
        T_0F38 | T_W0 | T_YMM | T_MUST_EVEX | T_B32,
        0x50,
    ),
    Insn::avx(
        "vpdpbuuds",
    ...
    Insn::avx(
        "vpdpwusd",
        T_66 | T_0F38 | T_W0 | T_YMM | T_MUST_EVEX | T_B32,
        0xD2,
    ),
    Insn::avx(
        "vpdpwusds",
    ...
    Insn::avx(
        "vfmaddcph",
        T_F3 | T_MAP6 | T_W0 | T_MUST_EVEX | T_ER_Z | T_YMM | T_B32,
        0x56,
    ),
    Insn::avx(
        "vfcmaddcph",
        T_F2 | T_MAP6 | T_W0 | T_MUST_EVEX | T_ER_Z | T_YMM | T_B32,
        0x56,
    ),
    Insn::avx(
        "vfmulcph",
...
pub static AVX_X_XM: &[Insn] = &[
    ...
    Insn::vex_xm(
        "vsqrtpd",
        T_0F | T_66 | T_YMM | T_EVEX | T_EW1 | T_B64 | T_ER_Z,
        0x51,
    ),
    ...
    Insn::vex_xm_imm(
        "vpermq",
        T_0F3A | T_66 | T_W1 | T_YMM | T_EVEX | T_EW1 | T_B64,
        0x00,
    ),
    Insn::vex_xm_imm(
        "vpermpd",
    ...
    Insn::vex_xm(
        "vbroadcastss",
        T_0F38 | T_66 | T_W0 | T_YMM | T_EVEX | T_N4,
        0x18,
    ),
    Insn::vex_xm(
        "vpbroadcastb",
        T_0F38 | T_66 | T_W0 | T_YMM | T_EVEX | T_N1,
        0x78,
    ),
    Insn::vex_xm(
        "vpbroadcastw",
        T_0F38 | T_66 | T_W0 | T_YMM | T_EVEX | T_N2,
        0x79,
    ),
    Insn::vex_xm(
        "vpbroadcastd",
    ...
    Insn::vex_xm(
        "vpbroadcastq",
        T_0F38 | T_66 | T_W0 | T_YMM | T_EVEX | T_EW1 | T_N8,
        0x59,
    ),
    // ptest
    ...
    Insn::vex_xm(
        "vcvtdq2ps",
        T_0F | T_YMM | T_EVEX | T_W0 | T_B32 | T_ER_Z,
        0x5B,
    ),
    Insn::vex_xm(
        "vcvtps2dq",
        T_0F | T_66 | T_YMM | T_EVEX | T_W0 | T_B32 | T_ER_Z,
        0x5B,
    ),
    Insn::vex_xm(
        "vcvttps2dq",
        T_0F | T_F3 | T_YMM | T_EVEX | T_W0 | T_B32 | T_SAE_Z,
        0x5B,
    ),
    ...
    Insn::vex_xm(
        "vmovddup",
        T_0F | T_F2 | T_YMM | T_EVEX | T_EW1 | T_DUP,
        0x12,
    ),
    // AES (AVX 2-operand)
    ...
    Insn::vex_xm(
        "vpmovsxbw",
        T_0F38 | T_66 | T_YMM | T_EVEX | T_N8 | T_N_VL,
        0x20,
    ),
    Insn::vex_xm(
        "vpmovsxbd",
        T_0F38 | T_66 | T_YMM | T_EVEX | T_N4 | T_N_VL,
        0x21,
    ),
    Insn::vex_xm(
        "vpmovsxbq",
        T_0F38 | T_66 | T_YMM | T_EVEX | T_N2 | T_N_VL,
        0x22,
    ),
    Insn::vex_xm(
        "vpmovsxwd",
    ...
    Insn::vex_xm(
        "vpmovsxdq",
        T_0F38 | T_66 | T_YMM | T_EVEX | T_W0 | T_N8 | T_N_VL,
        0x25,
    ),
    Insn::vex_xm(
        "vpmovzxbw",
    ...
    Insn::vex_xm(
        "vbroadcastf32x2",
        T_66 | T_0F38 | T_YMM | T_MUST_EVEX | T_W0 | T_N8,
        0x19,
    ),
    Insn::vex_xm(
        "vbroadcastf32x4",
        T_66 | T_0F38 | T_YMM | T_MUST_EVEX | T_W0 | T_N16,
        0x1A,
    ),
    Insn::vex_xm(
        "vbroadcastf64x2",
        T_66 | T_0F38 | T_YMM | T_MUST_EVEX | T_EW1 | T_N16,
        0x1A,
    ),
    Insn::vex_xm(
        "vbroadcastf32x8",
        T_66 | T_0F38 | T_YMM | T_MUST_EVEX | T_W0 | T_N32,
        0x1B,
    ),
    Insn::vex_xm(
        "vbroadcastf64x4",
        T_66 | T_0F38 | T_YMM | T_MUST_EVEX | T_EW1 | T_N32,
        0x1B,
    ),
    Insn::vex_xm(
        "vbroadcasti32x2",
    ...
    Insn::vex_xm(
        "vcvtdq2pd",
        T_0F | T_F3 | T_YMM | T_EVEX | T_W0 | T_B32 | T_N8 | T_N_VL,
        0xE6,
    ),
    Insn::vex_xm(
        "vcvtps2pd",
        T_0F | T_YMM | T_EVEX | T_W0 | T_B32 | T_N8 | T_N_VL | T_SAE_Y,
        0x5A,
    ),
    Insn::vex_xm(
        "vcvtph2ps",
        T_0F38 | T_66 | T_W0 | T_EVEX | T_YMM | T_N8 | T_N_VL | T_SAE_Y,
        0x13,
    ),
    Insn::vex_xm(
        "vcvtudq2pd",
        T_N8 | T_N_VL | T_F3 | T_0F | T_W0 | T_YMM | T_MUST_EVEX | T_B32,
        0x7A,
    ),
    // Narrowing conversions (2-op, dst narrower than src)
    Insn::vex_xm(
        "vcvtpd2dq",
        T_0F | T_F2 | T_YMM | T_EVEX | T_EW1 | T_B64 | T_ER_Z | T_N16 | T_N_VL,
        0xE6,
    ),
    Insn::vex_xm(
        "vcvtpd2ps",
        T_0F | T_66 | T_YMM | T_EVEX | T_EW1 | T_B64 | T_ER_Z | T_N16 | T_N_VL,
        0x5A,
    ),
    Insn::vex_xm(
        "vcvttpd2dq",
        T_66 | T_0F | T_YMM | T_EVEX | T_EW1 | T_B64 | T_SAE_Z | T_N16 | T_N_VL,
        0xE6,
    ),
    // vlddqu
...
pub static AVX_MOV: &[Insn] = &[
    Insn::vex_mov(
        "vmovdqa32",
        T_66 | T_0F | T_YMM | T_MUST_EVEX | T_EW0,
        0x6F,
        0x7F,
    ),
    Insn::vex_mov(
        "vmovdqa64",
        T_66 | T_0F | T_YMM | T_MUST_EVEX | T_EW1,
        0x6F,
        0x7F,
    ),
    Insn::vex_mov(
        "vmovdqu8",
        T_F2 | T_0F | T_YMM | T_MUST_EVEX | T_EW0,
        0x6F,
        0x7F,
    ),
    Insn::vex_mov(
        "vmovdqu16",
        T_F2 | T_0F | T_YMM | T_MUST_EVEX | T_EW1,
        0x6F,
        0x7F,
    ),
    Insn::vex_mov(
        "vmovdqu32",
        T_F3 | T_0F | T_YMM | T_MUST_EVEX | T_EW0,
        0x6F,
        0x7F,
    ),
    Insn::vex_mov(
        "vmovdqu64",
        T_F3 | T_0F | T_YMM | T_MUST_EVEX | T_EW1,
        0x6F,
        0x7F,
    ),
];
...
pub static FMA: &[Insn] = &[
    ...
    Insn::avx(
        "vfmadd132pd",
        T_0F38 | T_66 | T_EVEX | T_W1 | T_EW1 | T_YMM | T_ER_Z | T_B64,
        0x98,
    ),
    Insn::avx(
        "vfmadd213pd",
    ...
    Insn::avx(
        "vfmadd132ps",
        T_0F38 | T_66 | T_EVEX | T_W0 | T_EW0 | T_YMM | T_ER_Z | T_B32,
        0x98,
    ),
    Insn::avx(
        "vfmadd213ps",
    ...
    Insn::avx(
        "vfmadd132sd",
        T_0F38 | T_66 | T_EVEX | T_W1 | T_EW1 | T_ER_X | T_N8,
        0x99,
    ),
    Insn::avx(
        "vfmadd213sd",
    ...
    Insn::avx(
        "vfmadd132ss",
        T_0F38 | T_66 | T_EVEX | T_W0 | T_EW0 | T_ER_X | T_N4,
        0x99,
    ),
    Insn::avx(
        "vfmadd213ss",
...
pub static AVX_FLOAT_3OP: &[Insn] = &[
    ...
    Insn::avx(
        "vandnps",
        T_0F | T_EVEX | T_YMM | T_EW0 | T_B32 | T_N16 | T_N_VL,
        0x55,
    ),
    Insn::avx(
        "vandnpd",
        T_66 | T_0F | T_EVEX | T_YMM | T_EW1 | T_B64 | T_N16 | T_N_VL,
        0x55,
    ),
    Insn::avx(
        "vmaxps",
    ...
    Insn::avx(
        "vmaxss",
        T_F3 | T_0F | T_EVEX | T_EW0 | T_N4 | T_SAE_X,
        0x5F,
    ),
    Insn::avx(
        "vmaxsd",
        T_F2 | T_0F | T_EVEX | T_EW1 | T_N8 | T_SAE_X,
        0x5F,
    ),
    Insn::avx(
        "vminps",
...
pub static AVX_CMP_2OP: &[Insn] = &[
    ...
    Insn::vex_xm(
        "vcomisd",
        T_0F | T_66 | T_EVEX | T_EW1 | T_SAE_X | T_N8,
        0x2F,
    ),
