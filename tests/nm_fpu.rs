...
fn test_nm_fpu_load_store() {
    ...
    for (addr, nasm_mem) in mems32() {
        ...
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fistp_m32(addr)),
        ));
    }
...
fn test_nm_fpu_arith() {
    ...
    for &(st, sn) in &[(ST1, "st1"), (ST3, "st3"), (ST7, "st7")] {
        ...
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fadd_st0_st(st)),
        ));
    }
    // fadd st(i), st(0)
    for &(st, sn) in &[(ST1, "st1"), (ST7, "st7")] {
        ...
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fadd_st_st0(st)),
        ));
    }
    // faddp st(i), st(0)
    for &(st, sn) in &[(ST1, "st1"), (ST7, "st7")] {
    ...
    for &(st, sn) in &[(ST1, "st1"), (ST7, "st7")] {
        ...
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fsub_st0_st(st)),
        ));
        let asm = format!("fsubr st0, {}", sn);
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fsubr_st0_st(st)),
        ));
    }
    // fsubp / fsubrp
    insns.push((
        "fsubp st1, st0".into(),
        Box::new(|a: &mut CodeAssembler| a.fsubp(ST1)),
    ));
    insns.push((
        "fsubrp st1, st0".into(),
        Box::new(|a: &mut CodeAssembler| a.fsubrp(ST1)),
    ));
    ...
    for &(st, sn) in &[(ST1, "st1"), (ST7, "st7")] {
        ...
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fmul_st0_st(st)),
        ));
    }
    insns.push((
        "fmulp st1, st0".into(),
        Box::new(|a: &mut CodeAssembler| a.fmulp(ST1)),
    ));
    ...
    for &(st, sn) in &[(ST1, "st1"), (ST7, "st7")] {
        ...
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fdiv_st0_st(st)),
        ));
        let asm = format!("fdivr st0, {}", sn);
        insns.push((
            asm,
            Box::new(move |a: &mut CodeAssembler| a.fdivr_st0_st(st)),
        ));
    }
    insns.push((
        "fdivp st1, st0".into(),
        Box::new(|a: &mut CodeAssembler| a.fdivp(ST1)),
    ));
    insns.push((
        "fdivrp st1, st0".into(),
        Box::new(|a: &mut CodeAssembler| a.fdivrp(ST1)),
    ));
...
fn test_nm_fpu_compare() {
    ...
    insns.push((
        "fcompp".into(),
        Box::new(|a: &mut CodeAssembler| a.fcompp()),
    ));
    // fucom
    for &(st, sn) in &[(ST1, "st1"), (ST7, "st7")] {
    ...
    insns.push((
        "fucompp".into(),
        Box::new(|a: &mut CodeAssembler| a.fucompp()),
    ));
...
fn test_nm_fpu_misc() {
    ...
    insns.push((
        "fpatan".into(),
        Box::new(|a: &mut CodeAssembler| a.fpatan()),
    ));
    insns.push((
        "frndint".into(),
        Box::new(|a: &mut CodeAssembler| a.frndint()),
    ));
    insns.push((
        "fscale".into(),
        Box::new(|a: &mut CodeAssembler| a.fscale()),
    ));
    insns.push(("f2xm1".into(), Box::new(|a: &mut CodeAssembler| a.f2xm1())));
    insns.push(("fyl2x".into(), Box::new(|a: &mut CodeAssembler| a.fyl2x())));
    insns.push((
        "fyl2xp1".into(),
        Box::new(|a: &mut CodeAssembler| a.fyl2xp1()),
    ));
    insns.push(("fprem".into(), Box::new(|a: &mut CodeAssembler| a.fprem())));
    insns.push((
        "fprem1".into(),
        Box::new(|a: &mut CodeAssembler| a.fprem1()),
    ));
    insns.push((
        "fxtract".into(),
        Box::new(|a: &mut CodeAssembler| a.fxtract()),
    ));
    ...
    insns.push((
        "fldl2t".into(),
        Box::new(|a: &mut CodeAssembler| a.fldl2t()),
    ));
    insns.push((
        "fldl2e".into(),
        Box::new(|a: &mut CodeAssembler| a.fldl2e()),
    ));
    insns.push((
        "fldlg2".into(),
        Box::new(|a: &mut CodeAssembler| a.fldlg2()),
    ));
    insns.push((
        "fldln2".into(),
        Box::new(|a: &mut CodeAssembler| a.fldln2()),
    ));
    ...
    insns.push((
        "fdecstp".into(),
        Box::new(|a: &mut CodeAssembler| a.fdecstp()),
    ));
    insns.push((
        "fincstp".into(),
        Box::new(|a: &mut CodeAssembler| a.fincstp()),
    ));
    insns.push(("fnop".into(), Box::new(|a: &mut CodeAssembler| a.fnop())));
    insns.push((
        "ffree st1".into(),
        Box::new(|a: &mut CodeAssembler| a.ffree(ST1)),
    ));
    insns.push((
        "ffree st7".into(),
        Box::new(|a: &mut CodeAssembler| a.ffree(ST7)),
    ));
...
fn test_nm_fpu_control() {
    ...
    insns.push((
        "fninit".into(),
        Box::new(|a: &mut CodeAssembler| a.fninit()),
    ));
    insns.push(("fwait".into(), Box::new(|a: &mut CodeAssembler| a.fwait())));
    insns.push((
        "fnclex".into(),
        Box::new(|a: &mut CodeAssembler| a.fnclex()),
    ));
    ...
    insns.push((
        "fnstsw ax".into(),
        Box::new(|a: &mut CodeAssembler| a.fnstsw_ax()),
    ));
